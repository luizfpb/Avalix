...
begin
  ...
  (null, 'Supino reto na máquina',             'chest', array['front_delts','triceps'], 'machine',       'horizontal_push', false),
  (null, 'Supino inclinado na máquina',        'chest', array['front_delts','triceps'], 'machine',       'horizontal_push', false),
  (null, 'Chest press na máquina',             'chest', array['front_delts','triceps'], 'machine',       'horizontal_push', false),
  ...
  (null, 'Crucifixo na máquina (peck deck)',   'chest', array['front_delts'],           'machine',       'isolation',       false),
  ...
  (null, 'Flexão de braços',                   'chest', array['front_delts','triceps','abs'], 'bodyweight', 'horizontal_push', false),
  (null, 'Flexão de braços inclinada',         'chest', array['front_delts','triceps'], 'bodyweight',    'horizontal_push', false),
  (null, 'Flexão de braços declinada',         'chest', array['front_delts','triceps'], 'bodyweight',    'horizontal_push', false),
  (null, 'Flexão na suspensão (TRX)',          'chest', array['front_delts','triceps','abs'], 'suspension', 'horizontal_push', false),
  ...
  (null, 'Barra fixa assistida na máquina',    'lats', array['biceps','upper_back'],              'machine',    'vertical_pull',   false),
  ...
  (null, 'Puxada pegada neutra (triângulo)',   'lats', array['biceps','upper_back'],              'cable',      'vertical_pull',   false),
  (null, 'Puxada pegada aberta',               'lats', array['biceps','upper_back','rear_delts'], 'cable',      'vertical_pull',   false),
  (null, 'Pulldown na máquina',                'lats', array['biceps','upper_back'],              'machine',    'vertical_pull',   false),
  ...
  (null, 'Pullover na máquina',                'lats', array['triceps'],                          'machine',    'isolation',       false),
  ...
  (null, 'Remada baixa no cabo (triângulo)',   'lats', array['upper_back','biceps','rear_delts'], 'cable',      'horizontal_pull', false),
  (null, 'Remada pronada no cabo',             'lats', array['upper_back','rear_delts','biceps'], 'cable',      'horizontal_pull', false),
  (null, 'Remada na máquina (apoio no peito)', 'lats', array['upper_back','biceps','rear_delts'], 'machine',    'horizontal_pull', false),
  ...
  (null, 'Remada na suspensão (TRX)',          'lats', array['upper_back','biceps','rear_delts'], 'suspension', 'horizontal_pull', false),
  ...
  (null, 'Remada alta na máquina (high row)',  'upper_back', array['rear_delts','traps','biceps'],'machine',   'horizontal_pull', false),
  ...
  (null, 'Remada alta no cabo para o pescoço', 'upper_back', array['rear_delts','traps'],         'cable',     'horizontal_pull', false),
  ...
  (null, 'Encolhimento na máquina',            'traps', array['forearms'], 'machine',       'isolation', false),
  ...
  -- =====================================================================
  (null, 'Desenvolvimento militar com barra (em pé)', 'front_delts', array['side_delts','triceps'], 'barbell','vertical_push', false),
  ...
  (null, 'Desenvolvimento na máquina',                'front_delts', array['side_delts','triceps'], 'machine','vertical_push', false),
  ...
  (null, 'Elevação frontal com halteres',             'front_delts', array['side_delts'], 'dumbbell','isolation', false),
  (null, 'Elevação frontal com barra',                'front_delts', array['side_delts'], 'barbell','isolation', false),
  (null, 'Elevação frontal no cabo',                  'front_delts', array['side_delts'], 'cable','isolation', false),
  (null, 'Elevação frontal com anilha',               'front_delts', array['side_delts'], 'plate','isolation', false),

  -- =====================================================================
  -- DELTOIDE LATERAL (side_delts)
  -- =====================================================================
  (null, 'Elevação lateral com halteres',      'side_delts', array['traps'], 'dumbbell','isolation', false),
  (null, 'Elevação lateral no cabo',           'side_delts', array['traps'], 'cable','isolation', true),
  (null, 'Elevação lateral na máquina',        'side_delts', array['traps'], 'machine','isolation', false),
  (null, 'Elevação lateral deitado de lado',   'side_delts', array[]::text[], 'dumbbell','isolation', true),
  (null, 'Elevação lateral com faixa',         'side_delts', array['traps'], 'resistance_band','isolation', false),
  ...
  (null, 'Crucifixo invertido curvado (em pé)',        'rear_delts', array['upper_back','traps'], 'dumbbell','isolation', false),
  (null, 'Crucifixo invertido na máquina (reverse peck)', 'rear_delts', array['upper_back','traps'], 'machine','isolation', false),
  ...
  (null, 'Rosca simultânea com halteres',      'biceps', array['forearms'], 'dumbbell','isolation', false),
  ...
  (null, 'Rosca Scott na máquina',             'biceps', array['forearms'], 'machine','isolation', false),
  ...
  -- TRICEPS
  -- =====================================================================
  (null, 'Tríceps na polia (barra reta)',      'triceps', array[]::text[], 'cable','isolation', false),
  (null, 'Tríceps na polia (corda)',           'triceps', array[]::text[], 'cable','isolation', false),
  (null, 'Tríceps na polia (barra V)',         'triceps', array[]::text[], 'cable','isolation', false),
  (null, 'Tríceps testa com barra W',          'triceps', array[]::text[], 'ez_bar','isolation', false),
  (null, 'Tríceps testa na barra reta',        'triceps', array[]::text[], 'barbell','isolation', false),
  (null, 'Tríceps testa com halteres',         'triceps', array[]::text[], 'dumbbell','isolation', false),
  (null, 'Tríceps francês com halter',         'triceps', array[]::text[], 'dumbbell','isolation', false),
  (null, 'Tríceps francês na corda (cabo)',    'triceps', array[]::text[], 'cable','isolation', false),
  (null, 'Extensão de tríceps acima da cabeça na máquina', 'triceps', array[]::text[], 'machine','isolation', false),
  (null, 'Tríceps coice com halter',           'triceps', array[]::text[], 'dumbbell','isolation', true),
  (null, 'Tríceps coice no cabo',              'triceps', array[]::text[], 'cable','isolation', true),
  (null, 'Extensão de tríceps unilateral no cabo', 'triceps', array[]::text[], 'cable','isolation', true),
  (null, 'Tríceps na máquina',                 'triceps', array[]::text[], 'machine','isolation', false),
  (null, 'Tríceps com faixa',                  'triceps', array[]::text[], 'resistance_band','isolation', false),
  ...
  (null, 'Mergulho nas paralelas (tríceps)',   'triceps', array['chest','front_delts'], 'bodyweight','horizontal_push', false),
  (null, 'Mergulho no banco (bench dip)',      'triceps', array['chest','front_delts'], 'bodyweight','horizontal_push', false),
  (null, 'Flexão diamante',                    'triceps', array['chest','front_delts'], 'bodyweight','horizontal_push', false),
  ...
  (null, 'Sustentação com halteres (hold)',    'forearms', array['traps'], 'dumbbell','carry', false),
  ...
  (null, 'Abdominal na máquina',               'abs', array[]::text[], 'machine','core', false),
  (null, 'Abdominal no cabo (ajoelhado)',      'abs', array['obliques'], 'cable','core', false),
  (null, 'Elevação de pernas suspenso',        'abs', array['obliques','lower_back'], 'bodyweight','core', false),
  (null, 'Elevação de joelhos na cadeira romana', 'abs', array['obliques'], 'bodyweight','core', false),
  (null, 'Elevação de pernas no solo',         'abs', array[]::text[], 'bodyweight','core', false),
  (null, 'Prancha frontal',                    'abs', array['obliques'], 'bodyweight','core', false),
  (null, 'Prancha na suspensão (TRX)',         'abs', array['obliques'], 'suspension','core', false),
  ...
  (null, 'Rotação russa (russian twist)',      'obliques', array['abs'], 'medicine_ball','rotation', false),
  ...
  (null, 'Flexão lateral com halter',          'obliques', array[]::text[], 'dumbbell','core', true),
  (null, 'Flexão lateral no cabo',             'obliques', array['abs'], 'cable','core', true),
  ...
  -- =====================================================================
  (null, 'Hiperextensão lombar (banco romano)','lower_back', array['glutes','hamstrings'], 'bodyweight','hinge', false),
  (null, 'Hiperextensão com anilha',           'lower_back', array['glutes','hamstrings'], 'plate','hinge', false),
  (null, 'Extensão lombar na máquina',         'lower_back', array['glutes'], 'machine','isolation', false),
  ...
  (null, 'Agachamento sumô com barra',         'quads', array['glutes','adductors','hamstrings'], 'barbell','squat', false),
  ...
  (null, 'Agachamento búlgaro com halteres',   'quads', array['glutes','adductors','hamstrings'], 'dumbbell','lunge', true),
  (null, 'Agachamento búlgaro no Smith',       'quads', array['glutes','hamstrings'], 'smith_machine','lunge', true),
  (null, 'Passada / step-up com halteres',     'quads', array['glutes','hamstrings'], 'dumbbell','lunge', true),
  (null, 'Avanço no Smith',                    'quads', array['glutes','hamstrings'], 'smith_machine','lunge', true),
  ...
  (null, 'Levantamento terra sumô',            'hamstrings', array['glutes','quads','adductors','lower_back'], 'barbell','hinge', false),
  (null, 'Levantamento terra com trap bar',    'hamstrings', array['glutes','quads','traps'], 'trap_bar','hinge', false),
  (null, 'Good morning (ênfase posterior)',    'hamstrings', array['glutes','lower_back'], 'barbell','hinge', false),
  ...
  (null, 'Flexora em pé unilateral',           'hamstrings', array[]::text[], 'machine','isolation', true),
  (null, 'Flexão nórdica (Nordic curl)',       'hamstrings', array['glutes'], 'bodyweight','isolation', false),
  ...
  -- GLUTEOS (glutes)
  -- =====================================================================
  (null, 'Elevação pélvica com barra (hip thrust)', 'glutes', array['hamstrings'], 'barbell','hinge', false),
  (null, 'Hip thrust unilateral com barra',    'glutes', array['hamstrings'], 'barbell','hinge', true),
  (null, 'Hip thrust na máquina',              'glutes', array['hamstrings'], 'machine','hinge', false),
  (null, 'Hip thrust no Smith',                'glutes', array['hamstrings'], 'smith_machine','hinge', false),
  (null, 'Ponte de glúteo (glute bridge)',     'glutes', array['hamstrings'], 'barbell','hinge', false),
  (null, 'Elevação pélvica (peso corporal)',   'glutes', array['hamstrings'], 'bodyweight','hinge', false),
  (null, 'Frog pump',                          'glutes', array['hamstrings'], 'bodyweight','hinge', false),
  (null, 'Coice de glúteo no cabo',            'glutes', array['hamstrings'], 'cable','isolation', true),
  (null, 'Coice de glúteo na máquina',         'glutes', array['hamstrings'], 'machine','isolation', true),
  (null, 'Coice de glúteo com faixa',          'glutes', array['hamstrings'], 'resistance_band','isolation', true),
  (null, 'Step-up alto (ênfase glúteo)',       'glutes', array['hamstrings','quads'], 'dumbbell','lunge', true),
  ...
  (null, 'Adução de quadril no cabo',          'adductors', array[]::text[], 'cable','isolation', true),
  (null, 'Adução com faixa',                   'adductors', array[]::text[], 'resistance_band','isolation', false),
  ...
  (null, 'Abdução de quadril no cabo',         'abductors', array['glutes'], 'cable','isolation', true),
  (null, 'Abdução em pé com faixa',            'abductors', array['glutes'], 'resistance_band','isolation', true),
  (null, 'Abdução deitado de lado',            'abductors', array['glutes'], 'bodyweight','isolation', true),
  ...
  -- PANTURRILHAS (calves)
  -- =====================================================================
  (null, 'Panturrilha em pé na máquina',       'calves', array[]::text[], 'machine','isolation', false),
  (null, 'Panturrilha sentado na máquina',     'calves', array[]::text[], 'machine','isolation', false),
  ...
  (null, 'Panturrilha em pé com halteres',     'calves', array[]::text[], 'dumbbell','isolation', false),
  (null, 'Panturrilha unilateral com halter',  'calves', array[]::text[], 'dumbbell','isolation', true),
  (null, 'Panturrilha em pé com barra',        'calves', array[]::text[], 'barbell','isolation', false),
  ...
  -- PESCOCO (neck)
  -- =====================================================================
  (null, 'Flexão de pescoço com anilha',       'neck', array[]::text[], 'plate','isolation', false),
  (null, 'Extensão de pescoço com anilha',     'neck', array[]::text[], 'plate','isolation', false),
  (null, 'Neck curl na máquina',               'neck', array[]::text[], 'machine','isolation', false),
  (null, 'Neck harness (extensao)',            'neck', array[]::text[], 'other','isolation', false),
  (null, 'Flexão lateral de pescoço com faixa','neck', array[]::text[], 'resistance_band','isolation', true),
  ...
  (null, 'Empurrar trenó (prowler)',           'quads', array['glutes','calves'], 'other','carry', false),
  (null, 'Puxar trenó (sled pull)',            'hamstrings', array['glutes','upper_back'], 'other','carry', false);
